...
/**
 * ScriptingDialogDefinition.java
 * Copyright (C) 2011 University of Waikato, Hamilton, New Zealand
 */
package adams.env;

import adams.gui.scripting.AbstractScriptingDialog;
 ...
 */
public class ScriptingDialogDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "scripting dialog";
  ...
  public String getFile() {
    return AbstractScriptingDialog.FILENAME;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/scripting", new String[0]);
  }
}
