...
/**
 * ImageViewerPanelDefinition.java
 ...
 */
public class ImageViewerPanelDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "image viewer panel";
  ...
  public String getFile() {
    return ImageViewerPanel.FILENAME;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/visualization/image", new String[0]);
  }
}
