...
/**
 * Definition for the ProvenanceTree props file.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 4584 $
 */
public class ProvenanceTreeDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "provenance tree";
  ...
  public String getFile() {
    return ProvenanceTree.FILENAME;
  }
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/gui/flow/provenance", new String[0]);
  }
}
