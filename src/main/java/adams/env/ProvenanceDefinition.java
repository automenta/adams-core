...
/**
 * Definition for the Provenance props file.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 4584 $
 */
public class ProvenanceDefinition
  ...
  /** the key as constant. */
  public final static String KEY = "provenance";
  ...
  public void update(AbstractEnvironment env) {
    add(env, Project.NAME + "/flow/provenance", new String[0]);
  }
}
