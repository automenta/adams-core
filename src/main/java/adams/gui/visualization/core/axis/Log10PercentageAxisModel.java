...
/**
 * An axis model for displaying log10(percentage) values.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 7804 $
 */
public class Log10PercentageAxisModel
  ...
  protected String doValueToDisplay(double value) {
    ...
    if (Double.isNaN(value)) {
      ...
      result = getActualFormatter().format(Math.log10(raw));
    }
