...
public abstract class AbstractPaintlet
  ...
  public boolean canPaint(PaintMoment moment) {
    if (getPaintMoment() == PaintMoment.MULTIPLE)
      return isEnabled();
    else
      return isEnabled() && (getPaintMoment() == moment);
  }
   ...
   */
  public abstract void performPaint(Graphics g, PaintMoment moment);
