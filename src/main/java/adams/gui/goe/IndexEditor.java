...
public class IndexEditor
  ...
  protected String getStringToPaint() {
    return "" + ((Index) getValue()).getIndex();
  }
  ...
  protected boolean isUnchanged(String s) {
    return s.equals(((Index) getValue()).getIndex());
  }
  ...
  protected void initForDisplay() {
    ...
    current = ((Index) getValue()).getIndex();
    if (!m_TextValue.getText().equals(current))
      m_TextValue.setText(current);
    m_TextValue.setToolTipText(((Index) getValue()).getExample());
