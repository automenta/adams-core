...
public class DiffPanel
  ...
  public JMenuBar getMenuBar() {
	...
	public void actionPerformed(ActionEvent e) {
      ...
      menu.add(submenu);
      m_RecentFilesHandlerLeft = new RecentFilesHandler<>(SESSION_FILE_LEFT, 5, submenu);
	...
	public void recentItemSelected(RecentItemEvent<JMenu,File> e) {
      ...
      menu.add(submenu);
      m_RecentFilesHandlerRight = new RecentFilesHandler<>(SESSION_FILE_RIGHT, 5, submenu);
