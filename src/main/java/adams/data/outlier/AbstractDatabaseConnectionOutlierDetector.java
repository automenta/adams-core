 ...
 * @param <T> the type of data container to analyze
 */
public abstract class AbstractDatabaseConnectionOutlierDetector<T extends DataContainer>
  extends AbstractOutlierDetector<T>
  implements DatabaseConnectionHandler {

  /** for serialization. */
  private static final long serialVersionUID = 8848033637860171357L;
