...
/**
 * ArrayCorrelationCoefficient.java
...
public class ArrayCorrelationCoefficient<T extends Number>
  ...
  public String globalInfo() {
    return
        "Calculates the correlation coefficient between the first array and "
  ...
  protected StatisticContainer doCalculate() {
    ...
    for (i = 1; i < size(); i++) {
      ...
      result.setCell(0, i - 1, StatUtils.correlationCoefficient(get(0), get(i)));
    }
