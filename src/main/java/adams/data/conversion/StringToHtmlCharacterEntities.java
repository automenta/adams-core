...
/**
 * StringToHtmlCharacterEntities.java
 ...
 */
public class StringToHtmlCharacterEntities
  ...
  public String globalInfo() {
    return 
	"Turns a string into valid HTML, replacing characters like '<', '>' "
	+ "etc with their character entities.";
  }
  ...
  protected Object doConvert() throws Exception {
    return HtmlUtils.toHTML((String) m_Input);
  }
}
