 ...
 */
public class StringToValidStorageName
  extends AbstractValidateString {

  /** for serialization. */
  private static final long serialVersionUID = -6388015940155411881L;
  ...
  public String globalInfo() {
    return "Turns any string into a valid storage name.";
  }
  ...
  protected String process(String input, String replace) throws Exception {
    return Storage.toValidName(input, replace);
  }
}
