...
public class IntegerAnonymizer
  extends AbstractAnonymizer<Integer> {
   ...
   */
  public IntegerAnonymizer(String id, int bufferSize) {
    super(id, bufferSize);
  }
   ...
   * @param bufferSize	the size of the buffer for unused IDs
   */
  public IntegerAnonymizer(String id, long seed, int bufferSize) {
   ...
   */
  @Override
  protected Integer toAnonymized(Integer id) {
    return id;
  }
}
