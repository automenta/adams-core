...
public class TechnicalInformation {
  ...
  protected Hashtable<Field,String> m_Values = new Hashtable<>();

  /** additional technical informations. */
  protected List<TechnicalInformation> m_Additional = new ArrayList<>();
  ...
  public String toBibTex() {
    ...
    iter = additional();
    while (iter.hasNext()) {
      result += "\n\n" + ((TechnicalInformation) iter.next()).toBibTex();
    }
