...
public class BaseDateTime
  ...
  /** the "-INF" date. */
  public final static String INF_PAST_DATE = "0001-01-01 00:00:00";

  /** the placeholder for "+INF" (infinity in the future). */
  public final static String INF_FUTURE = "+INF";

  /** the "+INF" date. */
  public final static String INF_FUTURE_DATE = "9999-12-31 23:59:59";
  ...
  public final static String FORMAT = Constants.TIMESTAMP_FORMAT;
