...
public class MixedCopyrightProcessor 
  extends AbstractCopyrightProcessor<MixedCopyright> {
  ...
  protected String getOutputFile(String prefix) {
    return prefix + "-copyright-mixed.txt";
  }
