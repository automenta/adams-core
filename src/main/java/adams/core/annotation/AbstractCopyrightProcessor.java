...
public abstract class AbstractCopyrightProcessor<T extends Annotation>
  ...
  public Set<String> getSupportedOptions() {
    return new HashSet<>(Arrays.asList(new String[]{"module", "output", "printheader"}));
  }
  ...
  public Set<String> getSupportedAnnotationTypes() {
    return new HashSet<>(Arrays.asList(new String[]{getAnnotationClass().getName()}));
  }
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    for (Object o: roundEnv.getElementsAnnotatedWith(getAnnotationClass())) {
