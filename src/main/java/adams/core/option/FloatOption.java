...
public class FloatOption
  extends AbstractNumericOption<Float> {
   ...
   */
  protected FloatOption(OptionManager owner, String commandline, String property,
      Object defValue) {
   ...
   */
  protected FloatOption(OptionManager owner, String commandline, String property,
      Object defValue, Float lower, Float upper) {
   ...
   */
  protected FloatOption(OptionManager owner, String commandline, String property,
      Object defValue, boolean outputDefValue, Float lower, Float upper) {
