 ...
 * @see #BIBTEX_STARTTAG
 * @see #BIBTEX_ENDTAG
 * @see weka.core.TechnicalInformationHandlerJavadoc
 */
public class TechnicalInformationHandlerJavadoc
  ...
  protected String generateJavadoc(int index) throws Exception {
    ...
    if (!ClassLocator.hasInterface(TechnicalInformationHandler.class, getInstance().getClass()))
  ...
  public static void main(String[] args) {
    runJavadoc(TechnicalInformationHandlerJavadoc.class, args);
  }
}
