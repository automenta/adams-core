...
/*
 * ListSystemProperties.java.java
 ...
 * &nbsp;&nbsp;&nbsp;Whether to output the property names in an array rather than one by one.
 * </pre>
 * 
 * <pre>-regexp &lt;adams.core.base.BaseRegExp&gt; (property: regExp)
 * &nbsp;&nbsp;&nbsp;The regular expression used for matching the property names.
 * &nbsp;&nbsp;&nbsp;default: .*
 * </pre>
 * 
...
public class ListSystemProperties
  ...
  public String outputArrayTipText() {
    return "Whether to output the property names in an array rather than one by one.";
  }
  ...
  public String regExpTipText() {
    return "The regular expression used for matching the property names.";
  }
  ...
  protected String doExecute() {
    ...
    if (m_RegExp.isMatchAll()) {
      if (!m_Invert)
	m_Queue.addAll(System.getProperties().stringPropertyNames());
    }
    else {
