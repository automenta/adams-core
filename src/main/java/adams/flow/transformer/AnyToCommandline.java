...
/**
 <!-- globalinfo-start -->
 * Turns an object into a string consisting of the the command-line.
 * <p/>
 <!-- globalinfo-end -->
 *
 <!-- flow-summary-start -->
...
public class AnyToCommandline
  ...
  protected String doExecute() {
    ...
    try {
      m_OutputToken = new Token(OptionUtils.getCommandLine(m_InputToken.getPayload()));
    }
    catch (Exception e) {
      m_OutputToken = null;
      result = handleException("Failed to generate commandline: " + m_InputToken.getPayload(), e);
    }
