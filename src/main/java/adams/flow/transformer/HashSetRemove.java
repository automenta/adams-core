...
public class HashSetRemove
  ...
  public String globalInfo() {
	...
	+ "The object passing through is interpreted as the object to remove.";
  }
  ...
  protected String doExecute() {
	...
	if (isLoggingEnabled())
	  getLogger().info("Removed: '" + value + "'");
      }
      else {
	getLogger().warning("Value '" + value + "' not available from hashset '" + m_StorageName + "', not removed!");
      }
    }
