...
public class CopyToClipboard
  ...
  public String globalInfo() {
    return 
	"Copies the data in this token to the system's clipboard using the "
	+ "specified clipboard manager.";
  }
  ...
  public String getQuickInfo() {
    return QuickInfoHelper.toString(this, "clipboardData", m_ClipboardData.getClass());
  }
