...
public class Scripted
  ...
  /** for serialization. */
  private static final long serialVersionUID = 533314494036572984L;
  ...
  public String globalInfo() {
    return "A transformer that uses an external script for processing the token(s).";
  }
