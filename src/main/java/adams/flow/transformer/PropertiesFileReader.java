...
public class PropertiesFileReader
   ...
   *
   * @return		<!-- flow-generates-start -->adams.core.Properties.class<!-- flow-generates-end -->
   */
  @Override
  ...
  protected String doExecute() {
	...
	result = "Failed to read properties file: " + file;
      ...
      result = handleException("Failed to read properties file: " + file, e);
    }
