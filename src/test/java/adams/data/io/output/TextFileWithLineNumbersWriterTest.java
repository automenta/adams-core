...
/**
 * Tests the adams.core.io.TextFileWithLineNumbersWriter class. Run from commandline with: <p/>
 * java adams.core.io.TextFileWithLineNumbersWriter
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 8851 $
 */
public class TextFileWithLineNumbersWriterTest
  ...
  protected HashSet<Platform> getPlatforms() {
    return new HashSet<>(Arrays.asList(new Platform[]{Platform.LINUX}));
  }
