...
/**
 * Test class for the OutlierDetector filter. Run from the command line with: <p/>
 * java adams.data.filter.OutlierDetectorTest
 * <p/>
 * Note: dummy test
 *
...
public class OutlierDetectorTest
   ...
   */
  public OutlierDetectorTest(String name) {
    super(name);
  }
