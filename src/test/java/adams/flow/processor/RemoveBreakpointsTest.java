...
/**
 * Tests the RemoveBreakpoints processor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 8665 $
 */
public class RemoveBreakpointsTest
   ...
   */
  public RemoveBreakpointsTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(RemoveBreakpointsTest.class);
  }
