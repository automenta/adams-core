...
/**
 * Test for CallableSource actor.
 *
 * @author fracpete
 * @author adams.core.option.FlowJUnitTestProducer (code generator)
 * @version $Revision: 8665 $
 */
public class CallableSource2Test
   ...
   */
  public CallableSource2Test(String name) {
    super(name);
  }
  ...
  protected void setUp() throws Exception {
    ...
    m_Regression.setReferenceFile(new File(Regression.REFERENCES + "/" + CallableSource.class.getPackage().getName().replace(".", "/")  + "/" + "GlobalSource2" + Regression.EXTENSION));
  }
  ...
  public static Test suite() {
    return new TestSuite(CallableSource2Test.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.flow.source.CallableSource tmp12 = new adams.flow.source.CallableSource();
      ...
      adams.flow.source.CallableSource tmp24 = new adams.flow.source.CallableSource();
