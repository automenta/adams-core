...
/*
 * GetEnvironmentVariableTest.java
...
/**
 * Test for GetEnvironmentVariable actor.
 *
 * @author fracpete
...
public class GetEnvironmentVariableTest
   ...
   */
  public GetEnvironmentVariableTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetEnvironmentVariableTest.class);
  }
