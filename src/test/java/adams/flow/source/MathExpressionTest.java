...
public class MathExpressionTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.MathExpression
      adams.flow.source.MathExpression mathexpression2 = new adams.flow.source.MathExpression();
      argOption = (AbstractArgumentOption) mathexpression2.getOptionManager().findByProperty("expression");
      mathexpression2.setExpression((adams.parser.MathematicalExpressionText) argOption.valueOf("6 * 7.0"));
      actors1[0] = mathexpression2;
