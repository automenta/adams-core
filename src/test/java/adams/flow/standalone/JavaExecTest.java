...
public class JavaExecTest
   ...
   */
  public JavaExecTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(JavaExecTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.JavaExec
      adams.flow.standalone.JavaExec javaexec2 = new adams.flow.standalone.JavaExec();
      abstractactor1[0] = javaexec2;
