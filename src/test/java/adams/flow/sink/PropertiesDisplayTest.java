 ...
 */
public class PropertiesDisplayTest
   ...
   */
  public PropertiesDisplayTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(PropertiesDisplayTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.PropertiesDisplay
      adams.flow.sink.PropertiesDisplay propertiesdisplay10 = new adams.flow.sink.PropertiesDisplay();
      actors1[3] = propertiesdisplay10;
