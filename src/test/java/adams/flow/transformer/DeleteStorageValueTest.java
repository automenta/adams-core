...
/**
 * Tests the DeleteStorageValue actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 4748 $
 */
public class DeleteStorageValueTest
   ...
   */
  public DeleteStorageValueTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    // Note: this results in no values written to "dumpfile.txt", i.e.,
    //       the file will be missing in the regression test - intentionally
    DeleteStorageValue dsv = new DeleteStorageValue();
    dsv.setStorageName(new StorageName("rand"));
