...
public class GetJsonValueTest
   ...
   */
  public GetJsonValueTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetJsonValueTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.GetJsonValue
      adams.flow.transformer.GetJsonValue getjsonvalue7 = new adams.flow.transformer.GetJsonValue();
      argOption = (AbstractArgumentOption) getjsonvalue7.getOptionManager().findByProperty("key");
      getjsonvalue7.setPath(new JsonPathExpression("precourse"));

      abstractactor1[2] = getjsonvalue7;
