...
/**
 * Test for GetPropertyValue actor.
 *
 * @author fracpete
...
public class GetPropertyValueTest
   ...
   */
  public GetPropertyValueTest(String name) {
    super(name);
  }
  ...
  public static Test suite() {
    return new TestSuite(GetPropertyValueTest.class);
  }
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.flow.transformer.GetPropertyValue getpropertyvalue6 = new adams.flow.transformer.GetPropertyValue();
      argOption = (AbstractArgumentOption) getpropertyvalue6.getOptionManager().findByProperty("key");
      getpropertyvalue6.setKey((adams.core.base.BaseRegExp) argOption.valueOf("hello"));
      actors1[2] = getpropertyvalue6;
