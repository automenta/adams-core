...
/**
 * Tests the CopyToClipboard actor.
 *
...
public class CopyToClipboardTest
   ...
   */
  public CopyToClipboardTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    fr.setReader(new SingleStringTextReader());

    CopyToClipboard c2c = new CopyToClipboard();
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sc, fr, c2c, df});
  ...
  public static Test suite() {
    return new TestSuite(CopyToClipboardTest.class);
  }
