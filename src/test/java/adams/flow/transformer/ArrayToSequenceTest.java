...
/**
 * Tests the ArrayToSequence actor.
 *
 * @author  fracpete (fracpete at waikato dot ac dot nz)
 * @version $Revision: 6839 $
 */
public class ArrayToSequenceTest
   ...
   */
  public ArrayToSequenceTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sfs, fr, a2s, df});
  ...
  public static Test suite() {
    return new TestSuite(ArrayToSequenceTest.class);
  }
