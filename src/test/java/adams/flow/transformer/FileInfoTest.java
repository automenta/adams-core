...
import adams.flow.transformer.FileInfo.InfoType;
import adams.test.TmpFile;

/**
 * Test for FileInfo actor.
 *
 * @author fracpete
...
public class FileInfoTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      // Flow.FileInfo
      adams.flow.transformer.FileInfo filesize4 = new adams.flow.transformer.FileInfo();
      filesize4.setType(InfoType.SIZE);
      actors1[1] = filesize4;
