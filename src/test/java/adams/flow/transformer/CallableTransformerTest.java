...
/**
 * Test for CallableTransformer actor.
 *
 * @author fracpete
...
public class CallableTransformerTest
  ...
  public AbstractActor getActor() {
    ...
    try {
      ...
      adams.flow.core.AbstractActor[] tmp13 = new adams.flow.core.AbstractActor[4];
      ...
      tmp13[1] = tmp16;
      adams.flow.transformer.CallableTransformer tmp19 = new adams.flow.transformer.CallableTransformer();
      ...
      tmp25[1] = tmp28;
      adams.flow.transformer.CallableTransformer tmp31 = new adams.flow.transformer.CallableTransformer();
