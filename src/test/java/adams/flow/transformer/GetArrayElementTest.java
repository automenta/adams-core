...
/**
 * Tests the GetArrayElement actor.
 *
...
public class GetArrayElementTest
   ...
   */
  public GetArrayElementTest(String name) {
    super(name);
  }
  ...
  public AbstractActor getActor() {
    ...
    GetArrayElement ae = new GetArrayElement();
    ae.setIndex(new Index("6"));
    ...
    Flow flow = new Flow();
    flow.setActors(new AbstractActor[]{sfs, fr, ae, df});
  ...
  public static Test suite() {
    return new TestSuite(GetArrayElementTest.class);
  }
